...
-----------
<div>
  <img src="../Screenshot/PreechVis.png" class="img-rounded" style="width:100%;"></img>
</div>

- [Try to use PreechVis](https://seongmin-mun.github.io/VisualSystem/Major/PreechVis/index.html)
...
- NLP : Morpheme analysis, TF-IDF (Term Frequency - Inverse Document Frequency), Pre-Processing (tokenization, lemetazation, N-gram, window size), etc.
- Tool : IntelliJ IDEA, PyCharm, Jupyter notebook, RStudio

Visual Technique

- Visual Method : Sunburst, Wordcloud, RadVis
